...
//import i5.las2peer.services.sensorProxyService.SensorProxyService;
...
//			node.startService(new ServiceNameVersion(SensorProxyService.class.getName(), "0.1.0"), "a pass");
//
//			// start connector
